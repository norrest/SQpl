...
jQuery(document).ready(function($){ 'use strict';
    ...
    if (!window.__volumioBackendStarted) {
     window.__volumioBackendStarted = true;
     backendRequest();
     // backendRequestSpop();
   }
    ...
    $('.btn-cmd').click(function(){
        ...
        // play/pause
            ...
            //if (json['currentsong'] != null) {
                ...
                window.clearInterval(GUI.currentKnob);
				if (cmd === 'play') {
					GUI.playPending = true;
					GUI.playPendingAt = Date.now();
					GUI.playPendingElapsed = parseInt(GUI.MpdState['elapsed'], 10) || 0;
				}
                sendCmd(cmd);
